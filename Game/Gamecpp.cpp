...
#include "Dependencies/Dependencies/freeglut/glut.h"
#include <stdio.h>
...
//
//	//glColor3f(1.0f, 1.0f, 1.0f); /* thiết lập màu vẽ: màu trắng */
...
//	glutInitWindowSize(600, 800); /* khởi tạo window kích thước 600 x 800 */
//	glutInitWindowPosition(200, 200); /* khởi tạo window tại ví trí
//   (100,100) trên screen */
//	glutCreateWindow("Tank"); /* tên của window là ‘Tank’ */
